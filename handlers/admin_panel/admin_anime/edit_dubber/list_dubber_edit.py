...
# =====================================================================
# 🛠 YORDAMCHI FUNKSIYA: Dubberlar Ro'yxati Tugmalarini Yasash
# =====================================================================
async def get_admin_dubbers_list_markup(
    ...
    # Boshqaruv tugmalari
    keyboard.append([
        InlineKeyboardButton(text="⬅️ Dubber menyu", callback_data="dubber_menu", style="danger")
    ])
...
# =====================================================================
# 📑 DUBBERLAR RO'YXATINI KO'RSATISH HANDLERI
# =====================================================================
@router.callback_query(F.data.startswith("list_edit_dubber_page:"))
async def list_edit_dubber_page_handler(callback: CallbackQuery, state: FSMContext, session: Any):
    await state.clear()
    ...
    markup = await get_admin_dubbers_list_markup(
        session=session, 
        page=page
    )
