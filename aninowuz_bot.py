...
def get_admin_kb(is_main=False):
    ...
    buttons = [
        ...
        [   
            InlineKeyboardButton("🧹 Admin logni tozalash", callback_data="clear_admin_logs"),
            InlineKeyboardButton("Admin loglar", callback_data="adm_logs")
        ],
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            A_MAIN: [
                ...
                CallbackQueryHandler(admin_panel_text_handler, pattern="^admin_main$"),
